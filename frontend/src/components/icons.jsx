/**
 * Small inline SVG icon set for the sidebar and UI. Each icon inherits the
 * current text color (`stroke="currentColor"`), so it themes with the menu.
 */
const base = {
  width: 20,
  height: 20,
...
export function StampIcon(props) {
  return (
    <svg {...base} {...props}>
      <path d="M9 3h6a2 2 0 0 1 2 2c0 2-2 3-2 5v2H9v-2c0-2-2-3-2-5a2 2 0 0 1 2-2z" />
...
export function ScrollIcon(props) {
  return (
    <svg {...base} {...props}>
      <path d="M6 3h12a2 2 0 0 1 2 2v12a2 2 0 0 0 2 2H8a2 2 0 0 1-2-2z" />

...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/voip", label: "VoIP Phone", icon: PhoneIcon },
      ...
      { to: "/referral-workflow", label: "Referral Workflow", icon: ShareIcon, feature: "referrals" },
      { to: "/pms", label: "PMS / EHR", icon: FolderIcon },
